          ...
          <div className="text-left h-full  lg:text-center flex flex-col-reverse lg:flex-col w-4/5">
            ...
            <div>
              <p className=" lg:mt-6 text-[10px]  font-rubik font-light text-home-bg-black">
                We chose these ergonomic chairs for our new corporate office, and they exceeded all
                expectations. Not only are they stylish and durable, but they’ve also significantly
                improved our employees' posture and energy levels.
              </p>
            </div>
          </div>
        </motion.div>
