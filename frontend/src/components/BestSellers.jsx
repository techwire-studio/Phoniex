  ...
  return (
    <div className="mt-20 overflow-hidden">
      <div className="w-full lg:flex">
        {/* --------------------Left Div-------------------- */}
        <div className="w-full lg:w-3/5 pl-8 lg:py-8 lg:pl-16 lg:px-8 bg-home-bg-black">
          <motion.div
            initial={{ opacity: 0 }}
                    ...
                    <div className="mt-2 mb-4 flex items-center gap-4 ">
                      <div className="mt-0 lg:mt-0 space-x-4">
                        <p>
                          ...
                          <span className="ml-2 text-body-mobile lg:text-body-desktop text-white">
      ...
      >
        ...
        <div className="m-auto w-[350px] font-rubik font-medium text-home-bg-black">
          ...
          <p className="text-[16px] text-home-bg-black mt-2">
            ...
            <span className="ml-2 text-black text-body-mobile lg:text-body-desktop">
      ...
      <div className="lg:mt-12 mt-2 flex justify-center">
        <button className="bg-home-bg-black text-white font-rubik font-medium px-16 lg:px-20 py-3 lg:py-6">
          BUY NOW
        </button>
      </div>
    </div>
